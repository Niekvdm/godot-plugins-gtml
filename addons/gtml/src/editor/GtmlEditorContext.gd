...
static func from_html(text: String, line: int, col: int, css_text: String) -> GtmlEditorContext:
	return _make("html", text, line, col, css_text)


static func from_css(text: String, line: int, col: int, html_text: String) -> GtmlEditorContext:
	return _make("css", text, line, col, html_text)


static func _make(kind: String, text: String, line: int, col: int, other: String) -> GtmlEditorContext:
	var c := GtmlEditorContext.new()
	c.kind = kind
	c.text = text
	c.cursor_line = line
	c.cursor_col = col
