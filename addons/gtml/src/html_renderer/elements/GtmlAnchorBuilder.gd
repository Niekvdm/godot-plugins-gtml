...
static func _build_anchor_inner(node, ctx: Dictionary) -> Control:
	...
	if has_complex_children:
		return _build_complex_anchor(node, ctx, style, defaults, gtml_view, href, target)
	else:
		return _build_simple_anchor(node, ctx, style, defaults, gtml_view, href, target)


static func _build_simple_anchor(node, ctx: Dictionary, style: Dictionary, defaults: Dictionary, gtml_view, href: String, target: String) -> Control:
...
static func _build_complex_anchor(node, ctx: Dictionary, style: Dictionary, defaults: Dictionary, gtml_view, href: String, target: String) -> Control:
