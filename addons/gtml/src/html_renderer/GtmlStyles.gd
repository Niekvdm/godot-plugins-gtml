class_name GtmlStyles
extends RefCounted

## Static utility class for applying CSS styles to Godot controls.
## Extracted from GtmlRenderer for reusability across element builders.
...
static func parse_box_alignment(value: String) -> int:
	match value:
		...
		"space-between", "space-around", "space-evenly":
			# These are handled by GtmlContainerBuilder._apply_space_distribution()
