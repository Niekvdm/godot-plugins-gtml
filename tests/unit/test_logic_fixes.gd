...
## Verifies the v0.2 logic fixes in GtmlStyles:
...
func test_text_transform_uppercase_still_mutates() -> void:
	...
	GtmlStyles.apply_text_styles(l, {"text-transform": "uppercase"}, {})
...
func test_font_weight_bold_uses_variant_from_dict() -> void:
	...
	GtmlStyles.apply_text_styles(l, {"font-family": "Roboto", "font-weight": 700}, defaults)
