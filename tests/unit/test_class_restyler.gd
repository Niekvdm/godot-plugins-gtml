...
## Tests for GtmlClassRestyler.resolve_visual_props — recompute the
...
func _node(tag: String, classes: String) -> Variant:
	var n = GtmlNodeScript.create_element(tag, {"class": classes})
	return n
...
func test_resolve_visual_props_pulls_color() -> void:
	...
	var props: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["rare"]), rules)
...
func test_resolve_visual_props_pulls_background() -> void:
	...
	var props: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["active"]), rules)
...
func test_resolve_visual_props_excludes_layout_keys() -> void:
	...
	var n = _node("div", "x")
	var props: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["x"]), rules)
...
func test_resolve_visual_props_compound_selector_needs_both() -> void:
	...
	var props_one: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["item"]), rules)
	assert_false(props_one.has("color"), "compound needs both classes")
	# Both active → matches.
	var props_both: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["item", "rare"]), rules)
...
func test_resolve_visual_props_restores_node_class_attr() -> void:
	...
	GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["base", "rare"]), rules)
...
func test_restyle_applies_background_color_to_panel() -> void:
	...
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["card"]), rules)
	GtmlClassRestyler.restyle(p, n, [n], PackedStringArray(["card", "active"]), rules, base, null)
...
func test_restyle_applies_font_color_to_label() -> void:
	...
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["name"]), rules)
	GtmlClassRestyler.restyle(label, n, [n], PackedStringArray(["name", "rare"]), rules, base, null)
...
func test_restyle_applies_opacity() -> void:
	...
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["box"]), rules)
	GtmlClassRestyler.restyle(ctrl, n, [n], PackedStringArray(["box", "dim"]), rules, base, null)
...
func test_restyle_removing_class_reverts_to_base_snapshot() -> void:
	...
	var label := Label.new()
	add_child_autofree(label)
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["base"]), rules)
	# Add rare → purple.
	GtmlClassRestyler.restyle(label, n, [n], PackedStringArray(["base", "rare"]), rules, base, null)
	# Remove rare → revert to base white.
	GtmlClassRestyler.restyle(label, n, [n], PackedStringArray(["base"]), rules, base, null)
	var c: Color = label.get_theme_color("font_color")
...
func test_restyle_revert_clears_override_when_no_static_rule() -> void:
	...
	var label := Label.new()
	add_child_autofree(label)
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["plain"]), rules)
	assert_false(base.has("color"), "no static rule → base lacks color")
	# Add rare → purple override applied.
	GtmlClassRestyler.restyle(label, n, [n], PackedStringArray(["plain", "rare"]), rules, base, null)
	assert_true(label.has_theme_color_override("font_color"), "rare applies an override")
	# Remove rare → override must be cleared.
	GtmlClassRestyler.restyle(label, n, [n], PackedStringArray(["plain"]), rules, base, null)
...
func test_restyle_layout_prop_in_dynamic_class_warns() -> void:
	...
	add_child_autofree(ctrl)
	var base: Dictionary = GtmlClassRestyler.resolve_visual_props(n, [n], PackedStringArray(["box"]), rules)
	GtmlClassRestyler.restyle(ctrl, n, [n], PackedStringArray(["box", "grow"]), rules, base, null)
